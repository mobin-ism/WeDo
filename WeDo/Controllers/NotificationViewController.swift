...
class NotificationViewController: UIViewController {
    ...
    func setupLoginLabel() {
        ...
        notificationLabel.centerXAnchor.constraint(equalTo: scrollView.centerXAnchor).isActive = true
        notificationLabel.topAnchor.constraint(equalTo: scrollView.topAnchor, constant: 16).isActive = true
    }
