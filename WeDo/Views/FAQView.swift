...
public class FAQConfiguration {
    ...
    func defaultValue() {
        ...
        self.separatorColor = UIColor(red: colorValue, green: colorValue, blue: colorValue, alpha: 0.5)
    }
}
...
class FAQViewCell: UITableViewCell {
    ...
    var indicatorImageView: UIImageView = {
        ...
        let indicatorImage = UIImage(named: "down-arrow")
    ...
    private func addLabelConstraints() {
        ...
        let indicatorWidth = NSLayoutConstraint(item: indicatorImageView, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 16)
        let indicatorHeight = NSLayoutConstraint(item: indicatorImageView, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 16)
